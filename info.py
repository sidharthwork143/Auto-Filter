...
# Bot information
API_ID = environ.get('API_ID', '28999970')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6713467384:AAEm7zVC8UhdZg4BkDSIoSOIPntr6aPqZpI')
if len(BOT_TOKEN) == 0:
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/duf9oo.jpg https://files.catbox.moe/uq3nx0.jpg https://files.catbox.moe/jkyzwz.jpg https://files.catbox.moe/3i3qgn.jpg https://files.catbox.moe/ytv5jp.jpg https://files.catbox.moe/n9ypco.jpg')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '5555597971')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001641766504').split()]
if len(INDEX_CHANNELS) == 0:
    logger.info('INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002095974601')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002290688332')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://sidharthwork143:HSrHmB33ZnT3fjR0@cluster0.o0ehhgc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(DATA_DATABASE_URL) == 0:
    logger.error('DATA_DATABASE_URL is missing, exiting now')
    exit()
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://sidharthwork143:HSrHmB33ZnT3fjR0@cluster0.o0ehhgc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(FILES_DATABASE_URL) == 0:
    logger.error('FILES_DATABASE_URL is missing, exiting now')
    exit()
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://sidharthwork143:HSrHmB33ZnT3fjR0@cluster0.o0ehhgc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(SECOND_FILES_DATABASE_URL) == 0:
    logger.info('SECOND_FILES_DATABASE_URL is empty')
DATABASE_NAME = environ.get('DATABASE_NAME', "justtest")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'justtest')

# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/GojoXSandman_Bot')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/filmy_men')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/filmy_men')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/filmy_men")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/filmy_men")
...
URL = environ.get("URL", "https://auto-filter-o68qn.kinsta.app")
if len(URL) == 0:
...
REACTIONS = [reactions for reactions in environ.get('REACTIONS', '').split()]  # Multiple reactions can be used separated by space
...
RECEIPT_SEND_USERNAME = environ.get("RECEIPT_SEND_USERNAME", "@sandmanbro")
